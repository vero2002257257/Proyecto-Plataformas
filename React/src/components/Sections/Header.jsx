  ...
  return (
    ...
    <Wrapper id="home" className="container flexSpaceCenter">
      <LeftSide className="flexCenter">
        <div>
          <h1 className="extraBold font60">¿Te atreves a vivir al límite?</h1>
          ...
          <li><Link to="/about">Acerca de</Link></li>
           <FullButton title={"Chulu"}></FullButton>
          ...
          <QuoteWrapper className="flexCenter darkBg radius8">
            ...
            <div>
              <p className="font15 whiteColor">
                <em>¿Qué haremos en nuestra primera cita?   
                  -Deja que impredecible nos sorprenda
                </em>
              </p>
              <p className="font13 orangeColor textRight" style={{marginTop: '10px'}}>Conversación de Juan y Laura</p>
            </div>
          </QuoteWrapper>
          <DotsWrapper>
            <Dots />
