  ...
  return (
    <Wrapper id="services">
      ...
      <div className="whiteBg" style={{ padding: "60px 0" }}>
        <div className="container">
          <HeaderInfo>
            <h1 className="font40 extraBold">¿Lugar o reto?</h1>
            <p className="font13">
              Al hacer On fire🔥 con tu impredecible tendrás la oportunidad 
              de
              <br />
            </p>
          </HeaderInfo>
          <ServiceBoxRow className="flex">
            ...
            <ServiceBoxWrapper>
              <ServiceBox icon="concierto"
               title="CONCIERTO" 
               />
               </ServiceBoxWrapper>
            <ServiceBoxWrapper>
              <ServiceBox icon="atracciones"
               title="ATRACCIONES" 
               />
            </ServiceBoxWrapper>
          </ServiceBoxRow>
